                    ...
                    <div class="sparkline8-list">
                        <div class="sparkline8-hd">
                            <div class="main-sparkline8-hd">
                                <h1 style="color: white; text-align: center;">Tambahkan Pengguna Baru</h1>
                                                ...
                                                <form method="POST" action="{{ route('user.store') }}">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                                <input type="text" class="form-control  @error('name') is-invalid @enderror" placeholder="Masukkan Nama Pengguna" style="color: white;" name="name" required autocomplete="name" autofocus>
                                                                @error('name')
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                                <input type="text" class="form-control  @error('username') is-invalid @enderror" placeholder="Masukkan Username" style="color: white;" name="username" required autocomplete="username" autofocus>
                                                                @error('username')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                                <input type="email" class="form-control  @error('email') is-invalid @enderror" placeholder="Masukkan Email" style="color: white;" name="email" required autocomplete="email" autofocus>
                                                                @error('email')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
