                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td scope="row">
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <a  data-toggle="tooltip" data-placement="bottom" title="Hapus Data" href="{!! url('tracking/destroy') !!}/{{$d->document_id}}" onclick="return confirm ('Apakah anda yakin untuk meghapus dokumen ini')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        @endforeach
